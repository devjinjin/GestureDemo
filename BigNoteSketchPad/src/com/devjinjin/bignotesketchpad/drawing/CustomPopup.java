 ...
 */
public abstract class CustomPopup extends PopupWindow {
	...
	public interface OnQuickActionClickListener {
		void onQuickActionClicked(CustomPopup widget, int position);
	}
	...
	/**
	 * By default, a {@link CustomPopup} is dismissed once the user clicked on a
	 * {@link QuickAction}. This behavior can be changed using this method.
	 * 
	 * @param dismissOnClick
	 *            True if you want the {@link CustomPopup} to be dismissed on
	 *            click else false.
	 */
	...
	/**
	 * Removes all {@link QuickAction} from this {@link CustomPopup}.
	 */
	...
	/**
	 * Call that method to display the {@link CustomPopup} anchored to the given
	 * view.
	 * 
	 * @param anchor
	 *            The view the {@link CustomPopup} will be anchored to.
	 */
	...
	public void show(View anchor) {
		...
		showAtLocation(anchor, Gravity.NO_GRAVITY, mRect.centerX() - mRect.width(), mPopupY);
	}
